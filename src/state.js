...
export const defaultState = {
  chapter: 1,
  objectives: [
    { id: "onboarding_open_explorer", label: "Boot sequence: open Node Directory to begin tracing the incident record", chapter: 1, roles: ["operator", "observer"], phase: "onboarding" },
    { id: "onboarding_run_help", label: "Boot sequence: run `help` in Terminal to identify continuity controls", chapter: 1, roles: ["operator", "observer"], phase: "onboarding" },
    { id: "onboarding_read_file", label: "Boot sequence: read one file for timeline clues", chapter: 1, roles: ["operator", "observer"], phase: "onboarding" },
    { id: "onboarding_progression_command", label: "Boot sequence: execute one mystery command (`unlock archive` / `set-time 03:11` / `recover --manifest`)", chapter: 1, roles: ["operator"], phase: "onboarding" },
    { id: "onboarding_confirm_objective_panel", label: "Boot sequence: confirm mission telemetry panel to track the investigation", chapter: 1, roles: ["operator", "observer"], phase: "onboarding" },
    { id: "unlock_archive", label: "Chapter 1: Expose the archive route to learn why records are gated", chapter: 1, roles: ["operator"] },
    { id: "set_time_0311", label: "Chapter 1: Align system time to 03:11 and test the maintenance lock", chapter: 1, roles: ["operator"] },
    { id: "observer_ping_operator", label: "Chapter 1 (Observer): transmit relay proof before it expires", chapter: 1, roles: ["observer"], coopOnly: true },
    { id: "operator_execute_relay", label: "Chapter 1 (Operator): execute observer relay code to preserve trust", chapter: 1, roles: ["operator"], coopOnly: true },
    { id: "recover_manifest", label: "Chapter 2: Recover the deleted manifest during the 03:11 window", chapter: 2, roles: ["operator"] },
    { id: "decode_cam2", label: "Chapter 2: Decode cam2 data for evidence that challenges the official timeline", chapter: 2, roles: ["operator"] },
    { id: "access_redacted_audit", label: "Chapter 2: Read the redacted audit and compare it to recovered records", chapter: 2, roles: ["observer", "operator"] },
    { id: "observer_anomaly_trace", label: "Chapter 2 (Observer): flag anomaly signatures that indicate post-hoc edits", chapter: 2, roles: ["observer"], coopOnly: true }
  ],
  completedObjectives: [],
  bootCount: 0,
  lastBootMessage: "",
